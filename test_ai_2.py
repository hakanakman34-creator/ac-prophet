...
print("DAY 1 DETAILS:")
for f in out.seven_day_forecast[0].forecasts:
    print(f"ASC_CODE: {f.ASC_CODE} - Carry: {f.Carryover_Jobs} - Pred: {f.Predicted_Jobs} - Comp: {f.Completed_Jobs} - Total: {f.Predicted_Total_Jobs}")
